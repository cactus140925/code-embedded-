...
int main(void)
{
  ...
  MX_GPIO_Init();
  /* USER CODE BEGIN 2 */
// Kh?i t?o LCD: bi?n LCD, b? I2C, d?a ch?, s? c?t, s? h�ng
   // Khởi tạo LCD chế độ 4 bit
  // Thứ tự: &biến, cột, hàng, RS_Port, RS_Pin, EN_Port, EN_Pin, D4_Port, D4_Pin, D5, D6, D7...
...
CLCD_WriteString(&LCD1, "TEST 4-BIT");
  /* USER CODE END 2 */
